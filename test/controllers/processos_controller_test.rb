...
class ProcessosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create processo" do
    assert_difference('Processo.count') do
      post processos_url, params: { processo: { data: @processo.data, data_receb: @processo.data_receb, numero: @processo.numero, solicitante: @processo.solicitante } }
    end
  ...
  test "should update processo" do
    patch processo_url(@processo), params: { processo: { data: @processo.data, data_receb: @processo.data_receb, numero: @processo.numero, solicitante: @processo.solicitante } }
